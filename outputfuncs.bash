...
#solrmarc_dir=$COMMONDIR/lib_solrmarc_install
#solrmarc_jar=$( find_newest_file_matching_pattern_under_directory $solrmarc_dir "solrmarc_core*.jar" )
#solrmarc_lib_dir=$solrmarc_dir/lib
marc4j_jar=$( find_newest_file_matching_pattern_under_directory $COMMONDIR "marc4j*.jar" )
#solrmarc_log_jar=$( find_newest_file_matching_pattern_under_directory $solrmarc_dir/lib "log4j*.jar" )
